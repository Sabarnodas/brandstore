...
function StoreProvider({ children }) {
    ...
    const cancelOrder = async (orderId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/orders/${orderId}/cancel`);
    ...
    const updateOrderDeliveryStatus = async (orderId, status, deliveryAgent)=>{
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/orders/${orderId}/status`, {
    ...
    const submitReview = async (productId, rating, comment)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/products/${productId}/reviews`, {
                rating,
                comment
            });
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/products');
...
//# sourceMappingURL=_20505835._.js.map